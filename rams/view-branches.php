                ...
                <form action="<?php echo $base_url; ?>" method="post">
                    <div class="input-group">
                        <span class="input-group-text" id="basic-addon2">
                            <h4>Pas de Branch aan</h4>
                        </span>
                        <input type="hidden" name="branchID" value="<?= $_GET['branchId'] ?>">
                        <input maxlength="255" name="branch_naam" type="text" class="form-control" placeholder="Branch_naam" aria-label="Branch" aria-describedby="basic-addon1" value="<?= $_GET['branch_naam'] ?>">

                        <br><br>
                        <h5>Klik op een afbeelding om de afbeelding toe te wijzen aan de branche</h5>
                        <?php
                        $counter = 0;
                        ...
                        echo "<br>";
                        ?>
                        <input id="imageURL" maxlength="255" name="branch_image" type="text" class="form-control" placeholder="Branch_image" aria-label="Branch" aria-describedby="basic-addon1" value="<?= $_GET['branch_image'] ?>">
                    </div>
                    </br>
                ...
                <form action="<?php echo $base_url; ?>" method="post">
                    <div class="input-group">
                        ...
                        <button onclick="history.go(-1);">Terug </button>
                            <h3>Voeg een branche toe</h3>
                        </span>
                        <h5>Branch naam:</h5>
                        <input maxlength="255" onchange="checkMaxLength()" name="branch_naam" type="text" class="form-control" placeholder="Branch" aria-label="Branch" aria-describedby="basic-addon1" required>
                        <!--Add Image-->
                        <br>
                        <h5>Klik op een afbeelding om de afbeelding toe te wijzen aan de nieuwe branche</h5>
                        ...
                        foreach ($list as $image) {
                            ...
                            echo "<td><a href='#' onclick='imageToURL(`image-" . $counter . "`)'><img id='image-" . $counter . "' class='col-sm-4' src='" . $image . "'></a></td>";
                            if ($counter % 3 != 0) {
                                echo "</tr>";
                            }
                        }
                        ...
                        <input id="imageURL" maxlength="250" onchange="checkMaxLength()" name="branch_image" type="text" class="form-control" placeholder="Branch URL" aria-label="Branch" aria-describedby="basic-addon1" required>
                        <br><br>
                    </div>
                    </br>
